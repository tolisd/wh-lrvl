...
@section('content_header')
    <h1>Αποθήκη/Warehouse | Αναθέσεις Εξαγωγής</h1>
@stop
    ...
    <div class="row">
        <div class="col-lg-12 col-xs-6">
            ...
            <table class="table data-table display table-striped table-bordered"
                ...
                <tbody>
                @foreach($my_export_assignments as $exportassignment)
                            ...
                            @else
                                @foreach($attached_files as $att_file)
                                    ...
                                    @if(\Auth::user()->user_type == 'normal_user')
                                        ...
                                        <a href="{{ route('user.assignments.export.getfiles', ['filenames' => basename($att_file)]) }}" download>
