...
@section('content_header')
    <h1>Αποθήκη/Warehouse | Αναθέσεις Εισαγωγής</h1>
@stop
    ...
    <div class="row">
        <div class="col-lg-12 col-xs-6">
            ...
            <table class="table data-table display table-striped table-bordered"
                ...
                <tbody>
                @foreach($my_import_assignments as $importassignment)
                            ...
                            @else
                                @foreach($attached_files as $att_file)
                                    ...
                                    @if(\Auth::user()->user_type == 'normal_user')
                                        ...
                                        <a href="{{ route('user.assignments.import.getfiles', ['filenames' => basename($att_file)]) }}" download>
