                            ...
                            @else
                                @foreach($attached_files as $att_file)
                                    ...
                                    @if(\Auth::user()->user_type == 'super_admin')
                                        ...
                                        <a href="{{ route('admin.assignment.export.files', ['filenames' => basename($att_file)]) }}" download>
                                    ...
                                    @if(\Auth::user()->user_type == 'company_ceo')
                                        @if(substr($att_file, -3) == 'pdf')
                                        <a href="{{ route('manager.assignment.export.files', ['filenames' => basename($att_file)]) }}" download>
                                            <i class="far fa-file-pdf fa-lg" aria-hidden="true"></i>
                                        </a>&nbsp;{{ substr(basename($att_file), 15) }}<br/>
                                    ...
                                    @if(\Auth::user()->user_type == 'accountant')
                                        @if(substr($att_file, -3) == 'pdf')
                                        <a href="{{ route('accountant.assignment.export.files', ['filenames' => basename($att_file)]) }}" download>
                                            <i class="far fa-file-pdf fa-lg" aria-hidden="true"></i>
                                        </a>&nbsp;{{ substr(basename($att_file), 15) }}<br/>
