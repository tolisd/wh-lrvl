    ...
    public function create_product(Request $request){
        ...
        if(\Gate::any(['isSuperAdmin', 'isCompanyCEO', 'isWarehouseForeman', 'isWarehouseWorker'])){
            ...
            $validation_rules = [
                ...
                'modal-input-quantity-create.*' => 'required|filled|numeric|gte:0',
            ...
            $custom_messages = [
                ...
                'modal-input-quantity-create.*.gte' => 'Η ποσότητα πρέπει να είναι 0 ή θετικός αριθμός',
    ...
    public function update_product(Request $request, $id){
        ...
        if(\Gate::any(['isSuperAdmin', 'isCompanyCEO', 'isWarehouseForeman', 'isWarehouseWorker'])){
            ...
            $validation_rules = [
                ...
                'modal-input-quantity-edit.*' => ['required', 'filled', 'numeric', 'gte:0'],
            ...
            $custom_messages = [
                ...
                'modal-input-quantity-edit.*.gte' => 'Η ποσότητα πρέπει να είναι 0 ή θετικός αριθμός',
